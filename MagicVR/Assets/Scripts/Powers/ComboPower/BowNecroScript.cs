...
public class BowNecroScript : ShootingPowerScript
{
	...
	public override void Update()
	{
		...
		&& Time.time > WaitTill && ProjectilePrimary == null){	
			...
			//var primaryHeadRB = SnakeScriptPrimary.Head.GetComponent<Rigidbody>();
			//primaryHeadRB.constraints = ChargeShots? RigidbodyConstraints.FreezePosition: RigidbodyConstraints.None;
